     ...
     function ControllerViewModel() {
      ...
      self.mdScreen = ResponsiveKnockoutUtils.createMediaQueryObservable(mdQuery);
       ...
       self.router.configure({
         'data': {label: 'Data-dashboard', isDefault: true},
      ...
      // Navigation setup
      var navData = [
      {name: 'Data dashboard', id: 'data',
      iconClass: 'oj-navigationlist-item-icon icon-font-24 chart-icon-24'},
      {name: 'Incidents', id: 'incidents',
       iconClass: 'oj-navigationlist-item-icon icon-font-24 demo-fire-icon-24'},
      {name: 'Customers', id: 'customers',
       iconClass: 'oj-navigationlist-item-icon icon-font-24 demo-people-icon-24'},
      {name: 'About', id: 'about',
       iconClass: 'oj-navigationlist-item-icon icon-font-24 demo-info-icon-24'}
      ];
      ...
      self.userLogin = ko.observable(userAcces());

// function to get user ID for login purpose
function userAcces() {
  username = "login through mail or user-id"
  return username
}
      ...
      self.footerLinks = ko.observableArray([
        new footerLink('About data checker', 'aboutDataChecker', 'http://www.google.com')
      ]);
     }
